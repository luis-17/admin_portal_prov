...
<div class="modal-body">
	<form class="row" name="formConvenio"> 
		<div class="form-group col-md-12 mb-md">
			...
			<input type="text" class="form-control input-sm" ng-model="fData.descripcion" placeholder="Descripción" required tabindex="10" />
		</div>
...
<div class="modal-footer">
    <button class="btn btn-primary" ng-click="aceptar(); $event.preventDefault();" ng-disabled="formConvenio.$invalid">Aceptar</button>
