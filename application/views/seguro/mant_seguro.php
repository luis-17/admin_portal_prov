...
<div class="modal-body">
	<form class="row" name="formSeguro"> 
...
<div class="modal-footer">
    <button class="btn btn-primary" ng-click="aceptar(); $event.preventDefault();" ng-disabled="formSeguro.$invalid">Aceptar</button>
